...
function isSymbol(value) {
  return typeof value == 'symbol' ||
    (isObjectLike_1(value) && isObject.baseGetTag(value) == symbolTag);
}
...
var ViewportProvider = /*#__PURE__*/function (_React$Component) {
  getPrototypeOf._inherits(ViewportProvider, _React$Component);
  ...
  function ViewportProvider() {
    ...
    getPrototypeOf._classCallCheck(this, ViewportProvider);
    ...
    defineProperty._defineProperty(getPrototypeOf._assertThisInitialized(_this), "updateWindowSize", function () {
      _this.setState({
        windowSize: _this.getWindowSize()
      });
    });

    defineProperty._defineProperty(getPrototypeOf._assertThisInitialized(_this), "within", function (min, max) {
    ...
    defineProperty._defineProperty(getPrototypeOf._assertThisInitialized(_this), "above", function (value) {
      return _this.within(value, -1);
    });

    defineProperty._defineProperty(getPrototypeOf._assertThisInitialized(_this), "below", function (value) {
  ...
  getPrototypeOf._createClass(ViewportProvider, [{
    ...
    value: function getWindowSize() {
      return _objectSpread({}, WINDOW_SIZE_BASE, {}, getCurrentWindowSize());
    ...
    value: function render() {
      ...
      var within = this.within,
          above = this.above,
          below = this.below;
      return /*#__PURE__*/React__default.createElement(ViewportContext.Provider, {
        value: _objectSpread({}, windowSize, {
          within: within,
          above: above,
          below: below
        })
...
var Viewport = function Viewport(props) {
  return /*#__PURE__*/React__default.createElement(ViewportContext.Consumer, props);
};
...
//# sourceMappingURL=Viewport-37371745.js.map
